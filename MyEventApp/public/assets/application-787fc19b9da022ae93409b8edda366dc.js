...
function continue_dialog(){
    $("#event_creation_dialog").show('slide', {direction: 'left'}, 1000);

    $("#friend_invite_dialog").show('slide', {direction: 'left'}, 1000);
}

function back_dialog(){
    $("event_creation_dialog").show('slide', {direction: 'right'}, 1000);
    $("friend_invite_dialog").show('slide', {direction: 'right'}, 1000);
}
/*
