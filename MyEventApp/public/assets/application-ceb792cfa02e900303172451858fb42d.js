...
function showMaybe(timeSlot) {
	maybeRecord = timeSlots[timeSlot].maybe.pop();
	timeSlots[timeSlot].active.element.parentNode.removeChild(timeSlots[timeSlot].active.element);
	timeSlots[timeSlot].active = timeSlots[timeSlot].maybe.pop();
...
function displayAddMaybe(eventRecord) {
	...
	maybeWrapper.onclick = function (event) {showMaybe(eventRecord.timeSlot)};
