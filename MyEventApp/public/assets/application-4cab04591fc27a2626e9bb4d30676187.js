...
function adjustOverlay(xFraction) {
	...
	if (xFraction > 0) {
		...
		document.getElementById('drag_container').style.background = 'red';
	}
	if (xFraction < 0) {
		overlay.setAttribute("class", "overlay_pos");
		document.getElementById('drag_container').style.background = 'blue';
	}
}
...
function addListeners(item) {
	...
	item.addEventListener("touchmove", function(e) {
		...
		xDiffFraction = (x - startX) / (document.body.clientWidth - startX);
		adjustOverlay(xDiffFraction);
	});
