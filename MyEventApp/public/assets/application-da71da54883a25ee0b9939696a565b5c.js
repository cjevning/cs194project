...
function continue_dialog(){
    $("#event_creation_dialog").animate({right: '350px' }, 400, 'easeOutBack');
    $("#friend_invite_dialog").animate({right: '350px' }, 400, 'easeOutBack');
}

function back_dialog(){
    $("event_creation_dialog").animate({left: '350px' }, 400, 'easeOutBack');
    $("friend_invite_dialog").animate({left: '350px' }, 400, 'easeOutBack');
}
/*
