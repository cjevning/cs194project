...
function processEventDetails(eventDetails) {
	...
	for (var invite in invitesArray) {
		...
		console.log(inviteCopy);
		image = document.createElement("IMG");
		image.className = "invite_image";
		imageSourceURL = inviteCopy["picture_url"];
		console.log(imageSourceURL);
		image.src = inviteCopy["picture_url"];
		image.alt = "Profile Picture";
		console.log(image);
		lastViewed.children[1].appendChild(image);
	}
}
